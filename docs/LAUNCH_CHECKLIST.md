...
- [x] Verify the home, Work, About, local offer and representative case studies at desktop and mobile widths.
...
- [x] Remove obsolete low-resolution and duplicate project captures.
...
- [ ] Confirm `/sitemap.xml` contains the home, Work, About, local offer and all case-study routes.
